    ...
    <div class="rcb_left">
        ...
        <div class="rcb_icon">
            <a href="<?php echo $urls[0]; ?>" class="rcl-login">
              <img src='/img/card.png' aria-hidden="true"></i><span><?php _e('Вхід','wp-recall'); ?></span>
                <!-- <i class="fa fa-sign-in" aria-hidden="true"></i><span><?php _e('Вхід','wp-recall'); ?></span> -->
                <div class="rcb_hiden"><span><?php _e('Вхід','wp-recall'); ?></span></div>
            </a>
        </div>
        <div class="rcb_icon">
            <a href="<?php echo $urls[1]; ?>" class="rcl-register">
                <i class="fa fa-book" aria-hidden="true"></i><span><?php _e('Реєстрація','wp-recall'); ?></span>
                <div class="rcb_hiden"><span><?php _e('Реєстрація','wp-recall'); ?></span></div>
            </a>
        </div>
        <?php } ?>
    ...
    <div class="rcb_right">
        ...
        <div class="rcb_right_menu">
            ...
            <div class="pr_sub_menu">
                ...
                <div class="rcb_line"><a href="<?php echo wp_logout_url('/'); ?>"><i class="fa fa-sign-out" aria-hidden="true"></i><span><?php _e('Вихід','wp-recall'); ?></span></a></div>
            </div>
        </div>
