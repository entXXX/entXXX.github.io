...
define('SECRET_SALT','yI5acd006zBFC2DnjANs=xP=hr0N22NU');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','boikomykola@ukr.net');
...
define('DBNAME','u582559673_ujyvu');
define('DBUSER','u582559673_ulamy');
define('DBPASS','System32');
